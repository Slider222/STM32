...
// CS (SDA)		PB12			SPI1_NSS	Chip select for SPI
// SCK			PB13			SPI1_SCK	Serial Clock for SPI
// MOSI			PB14 		SPI1_MOSI	Master In Slave Out for SPI
// MISO			PB15			SPI1_MISO	Master Out Slave In for SPI
// IRQ			-			Irq
// GND			GND			Ground
